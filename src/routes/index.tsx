...
export const Route = createFileRoute("/")({
    head: () => ({
        meta: [
            ...
            { name: "description", content: "Burgers, fried chicken, fries — ordered fast with real-time microservice tracking." },
            { property: "og:title", content: "Châu Ngọc Thảo Fast-Food" },
            { property: "og:description", content: "Burgers, fried chicken, fries — ordered fast with real-time microservice tracking." },
        ],
    }),
    component: Home,
});
        ...
        <main>
                ...
                <div className="relative mx-auto grid min-h-[calc(100svh-4rem)] max-w-6xl items-center gap-8 px-5 py-8 md:py-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10 lg:py-10">
                    <div>
                        ...
                        >
                            ...
                            <span className="bg-gradient-sun bg-clip-text text-transparent">Traditional Taste</span>{" "}
                        ...
                        >
                            Châu Ngọc Thảo specializes in premium salt-baked chicken, traditional mixed salads, and authentic Vietnamese snacks — delivered fresh with real-time order tracking.
                        </motion.p>
                        <motion.div
                            initial={{ opacity: 0, y: 14 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        <div className="mt-6 grid grid-cols-3 gap-3 text-sm">
                            {[
                                ...
                                <div key={s.label} className="rounded-2xl border border-border bg-card p-3 shadow-card md:p-3.5">
            ...
            <section className="mx-auto max-w-6xl px-5 py-16">
                <div className="mb-8 flex items-end justify-between gap-4">
                    ...
                    <Link to="/menu" className="hidden text-sm font-bold text-foreground hover:underline md:inline">
                        See full menu →
                    </Link>
                </div>
