            ...
            <div className="flex h-full flex-col rounded-2xl border border-border bg-card shadow-card">
                <header className="flex items-center justify-between border-b border-border p-4">
                    <div>
                        ...
                        <h3 className="text-lg font-bold">{count} {count === 1 ? "item" : "items"}</h3>
                    </div>
                    {count > 0 && (
                        <button
                            onClick={() => cart.clear()}
                ...
                <footer className="space-y-3 border-t border-border p-4">
                    ...
                    <Link
                        to="/checkout"
                        onClick={onCheckout}
                        className={`flex w-full items-center justify-center rounded-xl px-4 py-3 text-sm font-bold transition ${count === 0
