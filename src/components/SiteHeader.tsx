            ...
            <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
                <Link to="/" className="flex items-center gap-3">
                    <span className="flex h-14 w-14 items-center justify-center overflow-hidden rounded-full">
                        <img src="/logo.png" alt="Chau Ngoc Thao logo" className="h-full w-full scale-[2.6] object-contain" />
                    </span>
                ...
                <nav className="hidden items-center gap-7 text-sm font-medium md:flex">
                    <Link to="/" activeOptions={{ exact: true }} activeProps={{ className: "text-foreground" }} className="text-muted-foreground hover:text-foreground">
                        Home
                    </Link>
                    <Link to="/menu" activeProps={{ className: "text-foreground" }} className="text-muted-foreground hover:text-foreground">
                        Menu
                    </Link>
                    <Link to="/track" activeProps={{ className: "text-foreground" }} className="text-muted-foreground hover:text-foreground">
                        Track Order
                    </Link>
                </nav>
                <Link
